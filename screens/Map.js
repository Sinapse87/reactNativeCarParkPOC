...
import { StyleSheet, Text, View, ScrollView, Dimensions, TouchableWithoutFeedback, TouchableOpacity, FlatList } from 'react-native';
            ...
            <View style={styles.parkingInfoContainer}>
              ...
              <View style={styles.buyTotal}>
                <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                  ...
                  <Text style={styles.buyTotalPrice}>{item.totalPrice}</Text>
                </View>
